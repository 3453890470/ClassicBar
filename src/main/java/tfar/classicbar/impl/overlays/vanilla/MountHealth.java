...
/**
 * ClassicBar overlay for {@link LivingEntity} mount health.
 * <p>
 * Renders the health of the player's current mount (e.g. horse, strider) as a
 * classic-style progress bar with gradient colors based on remaining mount health.
 */
