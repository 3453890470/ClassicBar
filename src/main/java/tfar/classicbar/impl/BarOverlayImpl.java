...
public abstract class BarOverlayImpl implements BarOverlay {
    ...
    public static final Identifier GUI_ICONS_LOCATION = BarIcons.FALLBACK;
    ...
    @Override
    public void render(HudRenderContext context, GuiGraphicsExtractor graphics, Player player, int screenWidth, int screenHeight, int vOffset) {
    ...
    public abstract void renderBar(HudRenderContext context, GuiGraphicsExtractor graphics, Player player, int screenWidth, int screenHeight, int vOffset);
    ...
    public void textHelper(GuiGraphicsExtractor graphics, int xStart, int yStart, double stat, double maxStat, int color, TextFormat format) {
    ...
    protected void renderSimpleText(GuiGraphicsExtractor graphics, int width, int height, int vOffset,
    ...
    public void renderFullBarBackground(GuiGraphicsExtractor graphics, int xStart, int yStart) {
        ModUtils.drawTexturedModalRect(graphics, xStart, yStart, 0, 0, WIDTH + 4, 9);
    }
    public void renderFullBar(GuiGraphicsExtractor graphics, int xStart, int yStart) {
        renderPartialBar(graphics,xStart,yStart,WIDTH);
    }
    public void renderPartialBar(GuiGraphicsExtractor graphics, double xStart, int yStart,double barWidth) {
        ModUtils.drawTexturedModalRect(graphics, xStart, yStart, BAR_U, BAR_V, barWidth, HEIGHT);
    }

    protected void renderPreviewBar(GuiGraphicsExtractor graphics, double previewValue, double maxValue,
    ...
    protected void renderWhitePreviewOverlay(GuiGraphicsExtractor graphics, double previewA, double previewB,
